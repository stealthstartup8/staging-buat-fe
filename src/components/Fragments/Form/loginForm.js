...
import VerifyPin from "../Popup/ForgotPassword/verifyPin";

const LoginForm = (props) => {
	const { onSubmit = () => {}, onChange, isFail, setIsFail, failMessage, loading } = props;
	const [open, setOpen] = useState(false);

	return (
		<>
			<VerifyPin open={open} setOpen={setOpen} />

			<div className="grid bg-white h-full">
				<form onSubmit={onSubmit} className="login-form border border-1 border-[#DCDCDC] p-4">
          ...
          <hr className="mb-8"></hr> */}
					...
					<div>
						<div
							...
							className="font-semibold text-[#082691] cursor-pointer"
						>
							Forget Password?
						</div>
						<Button
							disabled={loading}
							type="submit"
							className={`mb-8 lg:w-[24rem] min-w-[100%] px-3 py-2 text-white rounded-sm mb-4 mt-2 ${
