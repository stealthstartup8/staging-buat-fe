			...
			{editable ? (
				...
				<HorizontalScrollWrapper>
					{value_component.components.map((item, index) => (
						<div
							key={"preview" + index}
							className="md:h-full pt-40 lg:pt-0 lg:px-20 w-screen  justify-center    md:flex md:flex-row-reverse items-center space-y-10 md:space-y-0 gap-10"
						>
