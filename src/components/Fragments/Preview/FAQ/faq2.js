...
const PreviewFAQ2 = ({
	...
	return (
		<SectionWrapper
			section={section}
			className="z-20  bg-[image:var(--image-url)] bg-no-repeat bg-cover bg-center grid grid-cols-1 md:grid-cols-2 md:w-screen h-[100%] lg:h-screen relative"
		>
			<div className="w-full h-full md:h-screen bg-gray-300 aspect-square md:aspect-auto">
				<Image
			...
			<div className="z-10 container mx-auto gap-4 mt-10 md:mt-0 items-center px-4 md:p-20 md:pr-14">
				<div>
					<Headline
