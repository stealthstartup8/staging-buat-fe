		...
		<React.Fragment>
			<div>
				...
				>
					...
					<MenuList
						className={` hidden max-w-screen-xl rounded-xl lg:block border-0 shadow-none p-0`}
					>
						<ul
							style={{
...
const PreviewNavbar2 = ({
	...
	return (
		<div className="fixed w-[100vw] z-30 lg:pt-4">
			{(!editable || show_navbar) && (
				<Navbar
					...
					className="mx-auto backdrop-blur-none container px-4 py-2 lg:rounded-[24px] rounded-none border-none "
				>
