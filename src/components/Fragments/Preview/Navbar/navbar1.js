...
function NavList({ navigation_menu, navigation_font, navigation_style, navigation_button, editable }) {
	...
	return (
		<List className="mt-4 mb-6 p-0 lg:mt-0 lg:mb-0 lg:flex-row items-center lg:p-1 gap-2 min-w-0">
...
const PreviewNavbar1 = ({
	...
	return (
		<div className="fixed w-[100vw] z-30 pb-2">
			{(!editable || show_navbar) && (
				...
				>
					<div className="mx-auto flex items-center justify-between text-blue-gray-900 w-[100%]">
						<div
							onClick={
								editable == true
									? (e) => {
