...
const PagesDeletePopup = ({ open, namePage, name_page, setNamePage, setOpen, deletePage, loading }) => {
	return (
		<Modal open={open} size="xs">
			...
			<Modal.Body>
				...
				<p className="text-sm text-black leading-5 mb-6 mt-4">
					Are you sure you want to delete the entire about page created?
				</p>
				<Input
					type="text"
					...
					value={namePage}
					onChange={(e) => setNamePage(e.target.value.replace(" ", "-"))}
...
export default PagesDeletePopup;
